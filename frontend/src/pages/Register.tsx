  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-6">
      <div className="card w-full max-w-md p-8 text-ink-900 dark:text-ink-50">
        ...
        <p className="mt-2 text-sm text-ink-500 dark:text-ink-200">Start tracking leads in minutes.</p>
        ...
        <p className="mt-4 text-sm text-ink-600 dark:text-ink-200">
          Already have an account? <Link className="font-semibold text-ink-900 dark:text-ink-50" to="/login">Log in</Link>
        </p>
      </div>
    </div>
  );
